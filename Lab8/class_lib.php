<?php
    ...
    class Producto{
        ...
        function obtener_imagen(){
            if ($this->opc >= 80){
                $this->img = "caritafeliz.jpg";
                return $this->img;
            } 
            else if($this->opc >= 50 & $this->opc <= 79){
                $this->img = "caritaseria.jpg";
                return $this->img;
            }
            else{
                $this->img = "caritatriste.jpg";
                return $this->img;
            }
        }
    }
