    ...
    class UsuariosMDB{
        ...
        public function insertarRegistro($nombre,$apellido,$email,$edad){
            try{
                ...
                echo "Ocurrio la siguiente excepcion al tratar de guadar el registro: ", $e->getMessage(), "\n";
            }
        }
        ...
        public function obtenerRegistros(){
            try{
                ...
                echo "Ocurrio la siguiente excepcion al tratar de leer los registro: ", $e->getMessage(), "\n";
            }
        }
    }
    ?>